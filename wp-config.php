...
/**
 * Parses a SQL Azure Connection string into an array
 */
...
$conn = parse_azure_connection_string(getenv('WORDPRESS_DATABASE'));

/** The name of the database for WordPress */
define('DB_NAME', $conn['Initial Catalog']);

/** Azure database username */
define('DB_USER', $conn['User ID']);

/** Azure database password */
define('DB_PASSWORD', $conn['Password']);

/** Azure hostname */
define('DB_HOST', $conn['Data Source']);
